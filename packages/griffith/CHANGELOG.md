...
* does not render 0 when duration and current time both are 0 ([9fe8e76](https://github.com/zhihu/griffith/commit/9fe8e7688667001a34a3845265addd7cf7444011))
...
* export LocaleProvider ([#290](https://github.com/zhihu/griffith/issues/290)) ([b55033a](https://github.com/zhihu/griffith/commit/b55033a))
...
* enableCrossWindowMessage split away from standalone ([83c857a](https://github.com/zhihu/griffith/commit/83c857a))
...
* no defaultQuality in qualities ([c6dabf3](https://github.com/zhihu/griffith/commit/c6dabf3))
...
* add hotkey t/p and tooltips ([#275](https://github.com/zhihu/griffith/issues/275)) ([690f605](https://github.com/zhihu/griffith/commit/690f605))
